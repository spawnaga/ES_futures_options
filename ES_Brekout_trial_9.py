...
class Trade():
    ...
    def __init__(self):
        ...
        self.call_option_volume = self.roll_contract(self.call_option_volume, self.call_option_price.bidSize)  # get
        # maximum calls volume
        self.put_option_volume = self.roll_contract(self.put_option_volume, self.put_option_price.bidSize)  # get
        # maximum puts volume
